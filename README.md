...
## สมาชิก / Member (Login · Register · Profile)

ปุ่ม **บัญชี** มุมขวาบน (ข้าง ๆ ปุ่มภาษา) — ดีไซน์เดียวกับ nidss/su

- **เข้าสู่ระบบ (Login)** — อีเมล/ชื่อผู้ใช้ + รหัสผ่าน (เดโม: ใส่อะไรก็ได้เมื่อมีบัญชีแล้ว)
- **สมัครสมาชิก (Register)** — ใช้แบบฟอร์ม **ขั้นตอนที่ 3 (ข้อมูลผู้สมัคร)** ของ su: วันเกิด, ชื่อ-นามสกุล, ที่อยู่ตามบัตร, ที่อยู่จัดส่ง (มีตัวเลือก "ใช้ที่อยู่ตามบัตร"), เบอร์, อีเมล, ช่องทางติดต่อ, อัปโหลดบัตรประชาชน
- **หน้าประวัติ (Profile)** — แสดงข้อมูลสมาชิกที่บันทึกไว้ + แก้ไข / ออกจากระบบ

> เก็บใน `localStorage` (เดโม)
